...
ALTER TABLE `reviews`
  ...
  ADD KEY `idx_game_reviews` (`game_id`,`user_id`);
...
--
ALTER TABLE `gamegenres`
  ADD CONSTRAINT `gamegenres_ibfk_1` FOREIGN KEY (`game_id`) REFERENCES `games` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `gamegenres_ibfk_2` FOREIGN KEY (`genre_id`) REFERENCES `genres` (`id`) ON DELETE CASCADE;
